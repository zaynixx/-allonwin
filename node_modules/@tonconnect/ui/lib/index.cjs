  ...
  const walletsList = createMemo(() => {
    ...
    const uiWallets = walletsList2.map((wallet) => {
      ...
      return __spreadProps(__spreadValues({}, wallet), {
        isSupportRequiredFeatures: (tonConnectUI == null ? void 0 : tonConnectUI.walletsRequiredFeatures) ? sdk.checkRequiredWalletFeatures((_a2 = wallet.features) != null ? _a2 : [], tonConnectUI.walletsRequiredFeatures) : true
      });
    });
    return uiWallets;
  });
